...
저는 Team.Business 에서 Front-End 분야를 담당해서 개발하고 있습니다. 그와 동시에 우리가 이런 서비스 개발만 하는가? 그것은 또 아닙니다. 우리들의 목표는 취업을 목표를 하기도 하지만, 중요한 것은 우리가 하나의 엔지니어, 디자이너로 성장하기 위해 이런 서비스 개발과 병행하여 여러 스터디를 통해 지식 공유 또한 하나의 인프라를 제공합니다.

### Business 팀에서의 활동

먼저, 제가 활동하는 Team.Business에서는 주요한 활동으로 

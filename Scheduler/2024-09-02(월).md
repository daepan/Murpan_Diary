...
tags:
  - daily
---
❮ [[2024|2024년]] / [[2024-09|09월]] / [[2024-W36|36주]] ❯
❮❮ [[2024-09-01(일)]] | 2024-09-02(월) | [[2024-09-03(화)]] ❯❯

> [!quote] A friend is what the heart needs all the time.
> 친구는 마음이 항상 필요로 하는 것입니다.
> — Henry van Dyke Jr.
...
## 오늘 작성한 노트
```dataview
List FROM "" WHERE file.cday = date("2024-09-02") SORT file.ctime desc

```

## 오늘 수정한 노트
```dataview
List FROM "" WHERE file.mday = date("2024-09-02") SORT file.mtime desc

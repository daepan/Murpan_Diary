...
❮❮ [[2024-08-09(금)]] | 2024-08-10(토) | [[2024-08-11(일)]] ❯❯
...
## 오늘 작성한 노트
```dataview
List FROM "" WHERE file.cday = date("2024-08-12") SORT file.ctime desc

```

## 오늘 수정한 노트
```dataview
List FROM "" WHERE file.mday = date("2024-08-12") SORT file.mtime desc

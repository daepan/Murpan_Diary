...
❮❮ [[2024-08-13(화)]] | 2024-08-14(수) | [[2024-08-15(목)]] ❯❯

> [!quote] Think like a man of action; act like a man of thought.
> 행동하는 사람처럼 생각하고, 생각하는 사람처럼 행동합니다.
> — Henri Bergson
...
## 오늘 작성한 노트
```dataview
List FROM "" WHERE file.cday = date("2024-08-14") SORT file.ctime desc

```

## 오늘 수정한 노트
```dataview
List FROM "" WHERE file.mday = date("2024-08-14") SORT file.mtime desc

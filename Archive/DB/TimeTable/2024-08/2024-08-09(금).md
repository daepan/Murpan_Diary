...
### 오늘 배운 것들
- 자바스크립트 클래스
	- 객체 지향 프로그래밍에서 가장 중요한 원리 중 하나는 '내부 인터페이스와 외부 인터페이스를 구분 짓는 것’은 캡슐화
	- 캡슐화의 이점
		- 지원 가능 : **내부 인터페이스를 엄격하게 구분하면, 클래스 개발자들은 사용자에게 알리지 않고도 자유롭게 내부 프로퍼티와 메서드들을 수정할 수 있다**
		- 복잡성 은닉: **구현 세부 사항이 숨김으로써 구현에 안정성을 가져간다.**
### 오늘 감사한 일
>[!note]
>
### 일기

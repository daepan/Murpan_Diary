...
❮❮ [[2024-09-03(화)]] | 2024-09-04(수) | [[2024-09-05(목)]] ❯❯
...
## 오늘 작성한 노트
```dataview
List FROM "" WHERE file.cday = date("2024-09-04") SORT file.ctime desc

```

## 오늘 수정한 노트
```dataview
List FROM "" WHERE file.mday = date("2024-09-04") SORT file.mtime desc

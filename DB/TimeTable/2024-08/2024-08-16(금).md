...
## 오늘 작성한 노트
```dataview
List FROM "" WHERE file.cday = date("2024-08-16") SORT file.ctime desc

```

## 오늘 수정한 노트
```dataview
List FROM "" WHERE file.mday = date("2024-08-16") SORT file.mtime desc

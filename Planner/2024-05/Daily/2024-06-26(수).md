...
❮❮ [[2024-06-25(화)]] | 2024-06-26(수) | [[2024-06-27(목)]] ❯❯
...
## 오늘 작성한 노트
```dataview
List FROM "" WHERE file.cday = date("2024-06-26") SORT file.ctime desc

```

## 오늘 수정한 노트
```dataview
List FROM "" WHERE file.mday = date("2024-06-26") SORT file.mtime desc

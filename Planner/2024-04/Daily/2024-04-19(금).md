...
❮❮ [[2024-04-18(목)]] | 2024-04-19(금) | [[2024-04-20(토)]] ❯❯
...
## 오늘 작성한 노트
```dataview
List FROM "" WHERE file.cday = date("2024-04-19") SORT file.ctime desc

```

## 오늘 수정한 노트
```dataview
List FROM "" WHERE file.mday = date("2024-04-19") SORT file.mtime desc
